...
- Registry/type-chain lookup now supports inline derived type-chain fallback during node→class resolution, but broader semantic subtype matching via repository type-extension graphs remains partial.
