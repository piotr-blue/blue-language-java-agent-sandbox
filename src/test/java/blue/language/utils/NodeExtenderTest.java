...
public class NodeExtenderTest {
    ...
    public void testExtendList() throws Exception {
        ...
        String listBlueId = BlueIdCalculatorV2.calculateSemanticBlueId(Arrays.asList(nodeA, nodeB));
    ...
    public void testExtendListDirectly() throws Exception {
        ...
        String listABBlueId = BlueIdCalculatorV2.calculateSemanticBlueId(Arrays.asList(nodeA, nodeB));
        ...
        String listABCBlueId = BlueIdCalculatorV2.calculateSemanticBlueId(Arrays.asList(nodeAB, nodeC));
