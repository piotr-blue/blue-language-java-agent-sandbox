...
public final class PayNoteCookbookExamples {
    ...
    public static Map<String, Node> tier1Tiny() {
        ...
        docs.put("ticket04_deliveryEscrowShipperCancel", shipmentEscrowCancelable());
        docs.put("ticket05_deliveryDisputeWindowRefund", ticket05DeliveryDisputeWindowRefund());
        docs.put("ticket06_milestoneContractorFourStage", milestoneContractorFourStage());
        docs.put("ticket07_marketplaceSplit1585", marketplaceSplit8515());
        docs.put("ticket08_subscriptionMonthlyStopOnCancel", ticket08SubscriptionMonthlyStopOnCancel());
        docs.put("ticket09_agentBudgetRemaining", agentBudgetWithChildPurchases());
    ...
    public static Map<String, Node> tier2Medium() {
        Map<String, Node> docs = new LinkedHashMap<String, Node>();
        docs.put("ticket11_travelBookingChain", agentTripFlightCancellation());
        docs.put("ticket12_insuranceStagedPayout", insurancePayoutStaged());
        docs.put("ticket13_factoringAdvanceSettle", invoiceFactoring());
        ...
        docs.put("ticket19_kycGating", internalLedgerKycFirst());
    ...
    public static Node shipmentEscrowSimple() {
        return PayNotes.payNote("Cookbook Shipment Escrow")
                ...
                .capture()
                    .lockOnInit()
                    .unlockOnOperation("confirmDelivery", op -> op
                            .channel("guarantorChannel")
                            .description("Guarantor confirms delivery")
                            .steps(steps -> steps.emitType("DeliveryConfirmed", CookbookEvents.DeliveryConfirmed.class, null)))
                    .done()
                .buildDocument();
    }
        ...
        return PayNotes.payNote("Ticket 01 — Satisfaction Unlock Capture")
                .capture()
                    ...
                    .unlockOnOperation("confirmSatisfaction", op -> op
                            .channel("payerChannel")
                            .description("Confirm satisfaction before capture.")
                            .steps(steps -> steps.emitType("SatisfactionConfirmed", VoucherEvents.SatisfactionConfirmed.class, null)))
                    .done()
                .buildDocument();
    }
