...
public final class WebhookEnvelopeV2 {
    ...
    private WebhookEnvelopeV2(Builder builder) {
    ...
    public static WebhookEnvelopeV2 fromSnapshot(ResolvedSnapshotV2 snapshot) {
        return builder()
    ...
    public static final class Builder {
        ...
        public WebhookEnvelopeV2 build() {
            return new WebhookEnvelopeV2(this);
        }
    }
}
